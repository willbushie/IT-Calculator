...
namespace IT_Calculator
{
    internal class file
    {
         ...
         * Inputs: 
         */
        public static void writeToLogFile() //bool arithmetic, String num1, String num2
        {
            ...
            if (!System.IO.File.Exists(logFilePath))
            {
                ...
                System.IO.File.Create(prevSessionLog);
                
            }

            using (System.IO.StreamWriter stream = System.IO.File.AppendText(prevSessionLog));
            {
